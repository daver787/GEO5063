...
ti=1.5:1:143.5;
yi=interp1(t,y,ti);
plot(ti,yi,'o','markerfacecolor','r');
xlabel('Time (index number)');
ylabel('Chlorophyll(mg/m^3)');
title('Figure 2');
...
si=spline(t,y,ti);
hold on;
plot(ti,si,'o','markerfacecolor','g');
legend('linear interpolation','cubic spline interpolation');
...
%plot the result as a red soline line with line width equal to 2
hold on;
...
%plot the result as a green solid line
hold on;
